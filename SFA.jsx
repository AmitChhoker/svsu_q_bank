...
import { sfaprogramData } from "./src/data/programData";
...
export default function SFA() {
  return (
    <>
      ...
      <Header/>
      <div className="sfa">
        <div className="faculty-names"><h1>Skill Faculty of Agriculture</h1></div>
        <div className="section-container">
           <div className="sfet_img">
            <img className="img" src="https://svsu.ac.in/wp-content/uploads/2025/01/sfa-banner.png" alt=""  height={"300px"} width={"200px"}  />
          </div>
          <div className=".left-section">
              <ProgramCard programs={sfaprogramData} />
          </div>
